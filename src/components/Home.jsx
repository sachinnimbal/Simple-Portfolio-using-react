      ...
      <div id="hero">
        ...
        >
          <g mask='url("#SvgjsMask1011")' fill="none">
            ...
            ></rect>
            <path
              d="M604.6008457473367 220.82472252729303L476.288706815634 140.08856028084273 342.3405329118099 231.92484980162192z"
              fill="rgba(28, 83, 142, 0.4)"
              class="triangle-float2"
            ></path>

            <path
              d="M670.9315239923276 157.08767776299248L519.457101216419 58.51367164030751 508.4368609237625 216.1104501343586z"
              fill="rgba(28, 83, 142, 0.4)"
              class="triangle-float3"
            ></path>

            <path
              d="M1342.9657759506686 473.3314694978758L1428.4939509227927 421.9409573398278 1291.5752637926205 387.8032945257517z"
              fill="rgba(28, 83, 142, 0.4)"
            ...
            <path
              d="M1397.1592983668618 59.63993955844245L1298.329341267689 17.689111682768015 1284.8180780037637 186.90946126936427z"
              fill="rgba(28, 83, 142, 0.4)"
              class="triangle-float1"
            ></path>
            ...
            <path
              d="M131.84764926325101 234.53378359936758L146.308494933545 292.53306769658707 226.07699824422724 241.84215714253634z"
              fill="rgba(28, 83, 142, 0.4)"
              class="triangle-float1"
            ></path>
        ...
        <div className="main">
          <div className="profile-name">
            <p>
              Hello, I am <span className="name">Sachin Nimbal</span>
            </p>
          </div>
          <div className="role">
            <p>
